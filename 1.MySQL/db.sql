...
CREATE TABLE RELACIONA(
	...
	FOREIGN KEY(ID_TEMA) REFERENCES TOPICOS(IDTEMA)
	);
...
LEFT JOIN RELACIONA RE ON RE.ID_INSCRITO = INSC.IDINSCRITO
LEFT JOIN TEMAS TM ON RE.ID_TEMA = TM.IDTEMA
WHERE TM.TEMA LIKE 'C%' OR TM.TEMA LIKE 'Rubi%'
AND INSC.IDINSCRITO != 1
ORDER BY INSC.NOME;
...
INSERT INTO USERS (IDUSER, USERNAME, PASSWORD) VALUES(NULL, 'test@email.com', SHA2('abcdef', 512));
INSERT INTO USERS (IDUSER, USERNAME, PASSWORD) VALUES(NULL, 'External User', SHA2('ABCdef@#', 512));
INSERT INTO USERS (IDUSER, USERNAME, PASSWORD) VALUES(NULL, 'userapi', SHA2('123456', 512));